...
using VladimirsUplift.Extensions;
using VladimirsUplift.Models;
using VladimirsUplift.Models.ViewModels;
using VladimirsUplift.Utility;

namespace VladimirsUplift.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            if (HttpContext.Session.GetObject<List<int>>(SD.SessionCart) != null) 
            {
                ...
                {
                    CartVM.ServiceList.Add(_unitOfWork.Service.GetFirstOrDefault(c=>c.Id == serviceId,includeProperties:"Frequency,Category"));
                }
            }
            return View(CartVM);
        }
